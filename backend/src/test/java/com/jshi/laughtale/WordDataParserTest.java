...
//
// @SpringBootTest
// public class WordDataParserTest {
// 	@Autowired
...
// 		System.out.println(wordDataList.size());
//
// 		for (WordData worddata : wordDataList) {
//
// 			String word = worddata.getWord();
// 			String definition = worddata.getDefinition();
// 			// System.out.println(worddata.getId() + " " + definition);
// 			if(definition==null)continue;
// 			Map<String, String> map = new TreeMap<>();
// 			parseString(definition, map);
// 			//파싱했는데 맵이 비어있는 경우
// 			createDefinitionForEmptyMap(map, definition);
...
// 			worddata.setDefinition(newDef.toString());
// 			// System.out.println(worddata.getDefinition());
